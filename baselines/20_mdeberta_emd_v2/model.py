"""mDeBERTa-v3-base with mean pooling, multi-sample dropout, EMD² loss, and median decode."""
import torch
...
class mDeBERTaEMD(nn.Module):
    """mDeBERTa-v3-base with mean pooling + multi-sample dropout, trained with EMD² loss."""
