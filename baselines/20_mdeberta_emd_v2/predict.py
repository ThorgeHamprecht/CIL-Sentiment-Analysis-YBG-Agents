"""Run trained mDeBERTa-EMD on test.csv and write a Kaggle submission CSV."""
import argparse
...
def main(args):
    ...
    model = mDeBERTaEMD(model_name=model_name, dropout=0.0).to(device)
    ...
    out_path = output_dir / "20_mdeberta_emd_v2_submission.csv"
