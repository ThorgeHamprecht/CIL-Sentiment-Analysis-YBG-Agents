...
#   bash /home/$USER/CIL-Sentiment-Analysis-YBG-Agents/baselines/submit_analyze.sh

VENV="/work/scratch/$USER/cil/venv"
DATA_DIR="/work/scratch/$USER/cil/data"
SCRIPT="/home/$USER/CIL-Sentiment-Analysis-YBG-Agents/baselines/analyze.py"
LOG_DIR="/work/scratch/$USER/cil/logs"
...
echo ""
echo "All 4 jobs queued. Check status with: squeue -u $USER"
echo ""
echo "Once complete, scp results back with:"
echo "  scp roliveir@<cluster>:${BASE}/06_rnn_bilstm/artifacts/val_preds.csv      ./val_preds_bilstm.csv"
echo "  scp roliveir@<cluster>:${BASE}/07_transformer_custom/artifacts/val_preds.csv ./val_preds_transformer.csv"
echo "  scp roliveir@<cluster>:${BASE}/08_rnn_improved/artifacts/val_preds.csv    ./val_preds_bilstm_attn.csv"
echo "  scp roliveir@<cluster>:${BASE}/09_mdeberta_coral/artifacts/val_preds.csv  ./val_preds_mdeberta.csv"
