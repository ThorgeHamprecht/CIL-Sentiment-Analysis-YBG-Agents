...
ARTIFACT_DIR="$SCRATCH/artifacts/28_contrastive_shared_head_${SUPCON_VARIANT}_${WEIGHT_TAG}_${WARMUP_TAG}"
SUBMISSION_PREFIX="28_shared_head_${SUPCON_VARIANT}_${WEIGHT_TAG}_${WARMUP_TAG}"
