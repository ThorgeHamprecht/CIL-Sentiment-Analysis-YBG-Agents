"""Generate submission CSV from a trained TwoStreamTransformer checkpoint."""
import argparse
...
from model import TwoStreamTransformer, ev_decode
...
def main(args):
    ...
    model = TwoStreamTransformer(
        ...
        dropout=0.0,
        max_len=max(saved_args["max_len_title"], saved_args["max_len_body"]) + 1,
    ).to(device)
    ...
    out = sub_dir / "submission_14_transformer_fasttext.csv"
