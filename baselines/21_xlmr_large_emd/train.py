"""Fine-tune XLM-RoBERTa-large with EMD² loss and median decode."""
import argparse
import os
import time
...
from model import emd_loss, median_decode, XLMRobertaEMD
...
def main(args):
    ...
    model = XLMRobertaEMD(model_name=MODEL_NAME, dropout=args.dropout).to(device)
