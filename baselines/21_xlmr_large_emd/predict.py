"""Run trained XLM-RoBERTa-large-EMD on test.csv and write a Kaggle submission CSV."""
import argparse
...
from model import XLMRobertaEMD, median_decode
...
def main(args):
    ...
    model_name = checkpoint.get("model_name", "FacebookAI/xlm-roberta-large")
    ...
    model = XLMRobertaEMD(model_name=model_name, dropout=0.0).to(device)
    ...
    out_path = output_dir / "21_xlmr_large_emd_submission.csv"
