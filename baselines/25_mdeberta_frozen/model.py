"""Frozen mDeBERTa-v3-base encoder + trainable head, EMD² loss, EMA."""
import torch
...
class mDeBERTaFrozen(nn.Module):
    """Frozen mDeBERTa encoder used as a static feature extractor.
    Only the classification head is trained.
    torch.no_grad() wraps the encoder forward to skip autograd tracking entirely.
    """
