"""Ensemble 3 seed checkpoints (seed-split), average softmax probs, median decode."""
import argparse
...
def main(args):
    ...
    seed_tag = "_".join(str(s) for s in loaded_seeds)
    out_path = output_dir / f"27_mdeberta_seed_split_seed{seed_tag}_submission.csv"
